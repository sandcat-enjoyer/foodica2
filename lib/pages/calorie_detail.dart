            ...
            if (snapshot.data!.value == null) {
              return Center(
                ...
                children: [
                  ...
                  Text(
                    "Start scanning products to see consumption details here.",
                    style: TextStyle(
                      fontFamily: "Poppins",
                      fontSize: 18,
                    ),
              ...
              values.forEach((key, value) {
                ...
                if (newProduct.productDetail?.scanTime?.day ==
                    selectedDate.day) {
