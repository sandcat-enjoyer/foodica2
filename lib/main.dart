...
//still needs functionality to display onboarding only once but i'm ignoring this for now
  int introViewed = 0;
          ...
          child: Row(
            ...
            children: <Widget>[
              TextButton(
                ...
                child: Text(
                  "Skip",
                  style: TextStyle(color: Color(0xFF0074E4), fontWeight: FontWeight.w600, fontFamily: "Poppins"),
                ),
              ),
              Container(
                child: Row(
  ...
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => const HomeScreenPage(),
